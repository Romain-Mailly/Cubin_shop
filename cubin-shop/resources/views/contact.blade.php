...
<br>
    ...
    <div class="md:flex md:items-center mb-6">
        ...
        <div>
            <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-yellow-600" id="prenom" name="prenom" type="text" placeholder="John">
        </div>
    </div>
    ...
    {{-- DATE DE NAISSANCE --}}
      <div class="md:flex md:items-center mb-6">
          ...
          <div>
            <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-green-500" id="ddn" name="ddn" type="date">
          </div>
        </div>
    ...
    <div class="md:flex md:items-center mb-6">
        ...
        <div>
          <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-red-500" id="cp" name="cp" type="number" placeholder="80000">
        </div>
      </div>
  ...
  <br>
    ...
    <div class="md:flex md:items-center mb-6">
        ...
        <div>
          <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-yellow-300" id="adresse" name="adresse" type="text" placeholder="30 rue de Poulainville">
        </div>
      </div>
  ...
  <br>
    ...
    <div class="md:flex md:items-center mb-6">
        ...
        <div>
          <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="ville" name="ville" type="text" placeholder="Amiens">
        </div>
      </div>
  ...
  <div class="md:flex md:items-center mb-6">
      ...
      <div>
        <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-pink-500" id="email" name="email" type="email" placeholder="john.doe@afpa.fr" required>
      </div>
    </div>
