...
<div class="text-center mx-auto w-full max-w-lg">
    <form class="bg-white shadow-md rounded px-8 pt-6 pb-8" method="POST" action="{{ Route('update.store', ['id' => $product[0]->pro_id ]) }}">
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="id" type="text" value="{{ $product[0]->pro_id }}" disabled>
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="cat_id" type="text" value="{{ $product[0]->pro_cat_id }}">
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="fou_id" type="text" value="{{ $product[0]->pro_fou_id }}">
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="ref" type="text" value="{{ $product[0]->pro_ref }}">
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="libelle" type="text" value="{{ $product[0]->pro_libelle }}">
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="desc" type="text" value="{{ $product[0]->pro_desc }}">
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="prix" type="text" value="{{ $product[0]->pro_prix }}">
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="stock" type="text" value="{{ $product[0]->pro_stock }}">
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="couleur" type="text" value="{{ $product[0]->pro_couleur }}">
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                name="photo" type="text" value="{{ $product[0]->pro_photo }}">
        </div>
        ...
        <div class="flex justify-around">
            ...
            <div class="flex">
                <a href="/products/{{ $product[0]->pro_id }}"
